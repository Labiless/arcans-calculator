<script>
    ...
    const dateTemplate = (
        ...
        y1 = placeholder, y2 = placeholder, y3 = placeholder, y4 = placeholder
    ...
    const onInput = (e) => {
        ...
        if((!isBackspace && inputValue.length === 8) 
        || (!isBackspace && !"1234567890".includes(c))) return false;
